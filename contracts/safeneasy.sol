...
#SafeNEasy fork, code is audited and can be checked by anyone.
#Another Shitcoin token but forget about safeelon here comes SAFENEASY!
0.1% to every 100th holder as drop till the dev wallet is empty!


#website: https://safeneasy.xyz (under construction, will be released soon)
#telegram: https://t.me/safeneasy
...
contract SafeNEasy is Context, IBEP20, Ownable {
    ...
    string private _name = "SafeNEasy";
    string private _symbol = "SAFENEASY";
